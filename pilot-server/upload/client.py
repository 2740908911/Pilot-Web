...
upload_client = Blueprint('upload_client', __name__)
...
# 文件列表
@upload_client.route('/api/upload/l1/getfile', methods=['GET'])
def get_file():
...
# 文件删除
@upload_client.route('/api/upload/l1/delfile', methods=['GET'])
