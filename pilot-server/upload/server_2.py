...
upload_server2 = Blueprint('upload_server2', __name__)


# 文件上传
@upload_server2.route('/api/upload/l3/client', methods=['POST'])
def upload_file():
...
# 文件列表
@upload_server2.route('/api/upload/l3/getfile', methods=['GET'])
def get_file():
...
# 文件删除
@upload_server2.route('/api/upload/l3/delfile', methods=['GET'])
